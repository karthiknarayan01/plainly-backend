...
is the live Console dashboard built on top of them.
...
## `ttft_breakdown.png` — the top-level README's chart
...
`analyze_latency.py` answers. That first run is what caught the
cold-start effect described in the top-level README — a fresh worker
